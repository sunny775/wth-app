  ...
  return (
    <>
      <MetaTags
        ...
        description={`Weather Information for ${location.name}, ${location.country}`}
        path={`${location.lat}/${location.lon}`}
      />
            ...
            <div className="flex justify-center items-center gap-6 mb-8 lg:mb-12">
              ...
              <div className="flex justify-center items-center flex-col">
                <div className="flex justify-center items-center gap-x-2">
                  <p className="text-2xl">{location.name.toUpperCase()}</p>
                  <Tooltip
                    className="sm:hidden"
                    text={
                      isFavorite(location)
